...
{            
        ...
        fetch(url,{
            ...
            class Mudeeriaths
            {
                constructor(no,id,mudeeriath_name,mudeeriath_code,majmoa_hawala,majmoa_hawala_detail,majmoa_pending_hawala,majmoa_mustharadi_controller,majmoa_visa_controller,majmoa_mustharadi_thadyath,majmoa_check_thadyath,majmoa_sarafa_joi,majmoa_pool_visa_shoda_af,majmoa_pool_visa_shoda_yuru,majmoa_pool_visa_shoda_dollar,majmoa_awayd) {
                this.no = no;
                this.id=id;
                ...
                addHtml() {
                    ...
                    let html2=`<tr>
                        ...
                        <td>${this.majmoa_pool_visa_shoda_dollar}</td><td>${this.majmoa_awayd}</td>
